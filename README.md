...
`/reports/` is a PIN-gated empty container for daily automation reports.

- Pin is checked by Cloudflare Pages Functions (`functions/api/*`)
- Pin and report bodies are **not** in this repo
- Setup: see `SETUP-REPORTS.md`
